...
const JiByteUsersBox = ({ name, color }) => {
  ...
  return (
    <div
      ...
      className='user-box flex justify-center items-center border-1 border-slate-50 py-5 rounded-lg transition-all duration-300  hover:-translate-y-2'
    >
...
// /* eslint-disable react/prop-types */
// const JiByteUsersBox = ({ name, color }) => {
//   const fadedColor = `rgba(${parseInt(color.slice(-6), 16)}, ${parseInt(
//     color.slice(-4, -2),
//     16
...
//         ></span>
//       </div>
//       <div style={{ color }} className='user'>
...
//   event.currentTarget.style.boxShadow = `0 10px 22px  rgba(${parseInt(
//     color.slice(-6 - 4),
//     16
