...
const ShowMoreCards = ({ filteredTemplate }) => {
	...
	return (
		<>
			<div
				className={`${!showAll ? "opacity-60" : "opacity-100"}
        card-container overflow-hidden cursor-pointer grid md:grid-cols-2 lg:grid-cols-3 gap-4 my-8 transition-all duration-300`}
			>
